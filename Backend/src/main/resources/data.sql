...
INSERT INTO material (id, nombre, descripcion, precio)
VALUES(1, 'Aire acondicionado', 'Aire acondicionado de 12000 BTU', 500);
INSERT INTO users (id,username,email,name,rut,role)
VALUES(1,'adminCasaExperto','casaexperto@usach.cl','Casa Experto Administraction','11111111-1','ADMIN');
